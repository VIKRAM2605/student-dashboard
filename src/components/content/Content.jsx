...
function Content() {
  return (
    <div id='content' className='flex rounded-2xl mt-3 ml-8 mr-8 max-sm:flex-col'> 
        <div className='w-1/3 ml-5 pl-5 pt-4 pb-4  '><h1 className='text-2xl font-normal max-sm:text-5xl'>Stay on top<br />of your competitors</h1>
        ...
        <div className='w-1/3 bg-transparent h-max pt-4 pb-4 max-sm:border-t-2 max-sm:w-auto max-sm:ml-8 max-sm:border-b-2'><h1 className='text-2xl font-medium pb-2'>GPA Analytics:</h1><div className=''><ChartExample></ChartExample></div></div>
